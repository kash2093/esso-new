  ...
  public <T> T getController(String controller){
    ...
    if (ret == null){
      if (org.cruxframework.crux.core.client.utils.StringUtils.unsafeEquals(controller, "mainController")){
        essogs.client.MainController_ControllerProxy __cont  = new essogs.client.MainController_ControllerProxy(this.view);
        __cont.screen = iocContainer.getessogs_client_MainController_MainView(org.cruxframework.crux.core.client.ioc.IoCResource.Scope.LOCAL, null);
